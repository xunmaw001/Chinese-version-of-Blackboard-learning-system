    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课件名称" prop="kechengName">
                       <el-input v-model="ruleForm.kechengName"
                                 placeholder="课件名称" clearable  :readonly="ro.kechengName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="课件名称" prop="kechengName">
                           <el-input v-model="ruleForm.kechengName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengPhoto" label="课件照片" prop="kechengPhoto">
                        <file-upload
                            tip="点击上传课件照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengPhoto" label="课件照片" prop="kechengPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="课件类型" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择课件类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="课件类型" prop="kechengValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="课件介绍" prop="kechengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kechengContent" label="课件介绍" prop="kechengContent">
