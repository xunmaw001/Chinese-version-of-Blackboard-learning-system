...
public class HuidaEntity<T> implements Serializable {
     ...
     * 作业成绩
     */
    @TableField(value = "huifu_chengji")

    private Integer huifuChengji;
	 ...
	 * 设置：作业成绩
	 */
    public Integer getHuifuChengji() {
        return huifuChengji;
    }
    /**
	 * 获取：作业成绩
    ...
    public void setHuifuChengji(Integer huifuChengji) {
        this.huifuChengji = huifuChengji;
    }
    /**
	 * 设置：批改状态
	 */
